...
{
    public class TestOffersController : ApiController
    {
        #region Properties
        ...
        /// <summary>
        /// Gets the list of all available TEST offers
        /// </summary>
        /// <returns></returns>
        ...
        /// GET api/public/TestOffers?pid={id}&request_attributes={values}
        ///<summary>
        ///Returns a collection of active test offers suitable for displaying on an offer wall filtered by Pid and request attributes.
        ...
        /// <summary>
        /// Gets the list of respondent attributes of a test offer
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// GET /api/public/TestOffers/{offerId}/QuotaCells
        ///<summary>
        ///Returns a collection of test offer quota expressions
        ///</summary>
